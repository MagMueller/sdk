...
Browser Use is managed browser infrastructure. We run a production-ready
Chromium browser for you with stealth, residential proxies, live preview, and
recording built in.

When you launch a browser, you get a **CDP URL**: the connection address that
Playwright, Puppeteer, or another browser automation client uses to control the
browser remotely.
