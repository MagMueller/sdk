...
description: "Launch a managed browser and get its CDP URL."
icon: rocket
---

Browser Use gives you a managed Chromium browser with stealth, residential
proxies, live preview, and recording.
