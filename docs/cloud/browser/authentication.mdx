...
curl -X POST https://api.browser-use.com/api/v1/agents/browser-use/runs \
  ...
  -d '{"task": "Summarize my unread emails", "browser_profile_id": "bp_123"}'
```
</CodeGroup>
...
- A **profile** is standalone, project-owned login state — [create and manage it](/cloud/browser-profiles).
